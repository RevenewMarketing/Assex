        ...
        <div>
          ...
          <ul>
            {footerContent.accounts.map((account, index) => (
              <li
                key={index}
                className={!account.isActive ? styles.noDrag : undefined}
              >
                {account.title}
              </li>
            ))}
        ...
        <div>
          ...
          <ul>
            {footerContent.conditions.map((condition, index) => (
              <li
                key={index}
                className={!condition.isActive ? styles.noDrag : undefined}
              >
                {condition.title}
              </li>
            ))}
        ...
        <div>
          ...
          <ul>
            {footerContent.markets.map((market, index) => (
              <li
                key={index}
                className={!market.isActive ? styles.noDrag : undefined}
              >
                {market.title}
              </li>
            ))}
        ...
        <div>
          ...
          <ul>
            {footerContent.aboutUs.map((about, index) => (
              <li
                key={index}
                className={!about.isActive ? styles.noDrag : undefined}
              >
                {about.title}
              </li>
            ))}
      ...
      <div className={styles.linksContainer}>
        {footerContent.links.map((link, index) => (
          <a
            href="#"
            key={index}
            className={!link.isActive ? styles.noDrag : undefined}
          >
            {link.title}
          </a>
        ))}
