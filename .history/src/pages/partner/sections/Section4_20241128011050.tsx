...
import laptopImage from '../../../assets/images/laptop.png'; // Replace with the actual path
import desktopImage from '../../../assets/images/desktop.png'; // Replace with the actual path
