  ...
  sections: [
    {
      title: '',
      description: [
        'The crypto market is a digital currency market that uses blockchain technology to create new coins and provide users with secure transactions.',
        'Trading crypto derivatives allows you to diversify your online portfolio and capitalize on the movements of cryptocurrency prices, whether they’re rising or falling.'
      ],
    },
    {
      title: 'Crypto trading hours',
      description: [
        'You can trade cryptocurrencies 24/7 except during server maintenance.',
        'We will inform you via email when this takes place.',
        'The below cryptocurrency pairs have close only mode:'
      ],
      list: [
        "BTCAUD, BTCJPY, BTCCNH, BTCTHB, BTCZAR: on Sunday from 20:35 to 21:05",
        "BTCXAU, BTCXAG: Monday - Thursday from 20:58 to 22:01 All timings are in server time (GMT+0). Learn more about trading hours in our Help Center."
      ]
    },
    {
      title: 'Spreads³',
