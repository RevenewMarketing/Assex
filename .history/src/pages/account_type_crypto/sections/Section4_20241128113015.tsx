...
const textContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      description: `You can trade cryptocurrencies 24/7 except during server maintenance. We will inform you via email when this takes place. The below cryptocurrency pairs have close only mode:`,
      list: [" BTCAUD, BTCJPY, BTCCNH, BTCTHB, BTCZAR: on Sunday from 20:35 to 21:05", "BTCXAU, BTCXAG: Monday - Thursday from 20:58 to 22:01 All timings are in server time (GMT+0). Learn more about trading hours in our Help Center."]
    },
    {
      title: 'Spreads³',
      description:'Spreads are always floating, so the spreads in the table above are yesterday’s averages. For live spreads, please refer to the trading platform. Please note that spreads may widen when the markets experience lower liquidity. This may persist until liquidity levels are restored.',
    },
    {
      title: 'Swaps',
