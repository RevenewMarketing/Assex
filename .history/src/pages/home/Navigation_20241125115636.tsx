...
const Navigation: React.FC = () => {
  ...
  return (
    <div
      className={`${styles.navigationWrapper} ${selectedMenu ? styles.blurBackground : ""}`}
      onClick={closeMenu}
    >
      {/* Top Navigation Bar */}
      ...
      {/* Dropdown Content */}
      {Object.keys(navigationData).includes(selectedMenu || "") && (
        <div
          className={`${styles.dropdownMenu} ${
            selectedMenu ? styles.slideIn : styles.slideOut
          }`}
